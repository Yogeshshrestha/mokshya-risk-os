...
const navItems = [
  { label: 'Dashboard', icon: 'M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6', to: `/organizations/${organizationId.value}/dashboard`, active: true },
...
<template>
  <aside class="w-[260px] bg-white border-r border-[#e0e8e7] h-screen sticky top-0 flex flex-col flex-shrink-0 overflow-y-auto">
    ...
    <nav class="flex-1 px-3 space-y-1.5">
      ...
      >
        <svg class="size-5.5" :class="[item.active ? 'text-[#09433e]' : 'text-[#6b8a87] group-hover:text-[#09433e]']" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="p-4 mt-auto border-t border-[#e0e8e7] space-y-1">
      ...
      >
        <svg class="size-5 text-[#6b8a87] group-hover:text-[#09423c] transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" :d="item.icon" />
        </svg>
