...
import type { AssetCreate, AssetType, DataSensitivity, BusinessCriticality } from '~/types/asset-risk'
...
const formData = ref<AssetCreate>({
  name: '',
...
const handleSubmit = async () => {
  ...
  try {
    await assetApi.createAsset(props.organizationId, {
      ...formData.value,
          ...
          >
            ...
            <div class="flex items-center justify-between p-6 sm:p-8 border-b border-gray-100">
              <div>
                ...
                <p class="text-[14px] text-[#4f9690] mt-1">Register a new asset in your inventory.</p>
              </div>
              <button
                @click="handleClose"
                :disabled="isLoading"
